                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-striped table-responsive">
                                <tbody>
                                    <tr>
                                        <th>Name: </th>
                                        <td><c:out value="${sessionScope.logMember.memberName}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Password: </th>
                                        <td><c:out value="${sessionScope.logMember.password}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Gender: </th>
                                        <td><c:out value="${sessionScope.logMember.gender}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Height: </th>
                                        <td><c:out value="${sessionScope.logMember.height}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Weight: </th>
                                        <td><c:out value="${sessionScope.logMember.weight}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Blood Group: </th>
                                        <td><c:out value="${sessionScope.logMember.bloodGroup}"/></td>
                                    </tr>
                                    <tr>
                                        <th>NID No: </th>
                                        <td><c:out value="${sessionScope.logMember.nidNo}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Address: </th>
                                        <td><c:out value="${sessionScope.logMember.address}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Phone: </th>
                                        <td><c:out value="${sessionScope.logMember.phone}"/></td>
                                    </tr>
                                    <tr>
                                        <th>Email: </th>
                                        <td><c:out value="${sessionScope.logMember.email}"/></td>
                                    </tr>
                                    <c:if test="${em !=null}">
