                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body ">
                                    <c:if test="${out.workoutId == null}">
                                        <form action="<%=request.getContextPath()%>/saveWorkout" method="post" >
                                        </c:if>
                                        <c:if test="${out.workoutId!= null}">
                                            <form action="<%=request.getContextPath()%>/updateWorkout" method="post">
                                            </c:if>  

                                            <div class="form-group">
                                                <label for="workoutId">Workout Id</label>
                                                <input value="${out.workoutId}"  name="workoutId" type="text" class="form-control" id="workoutId">
                                            </div>
                                            <div class="form-group">
                                                <label for="workoutName">Workout Name:</label>
                                                <input value="${out.workoutName}" name="workoutName" type="text" class="form-control" id="workoutName">
                                            </div>
                                            <div class="form-group">
                                                <label for="calorieBurn">Calorie Burn:</label>
                                                <input value="${out.calorieBurn}" name="calorieBurn" type="text" class="form-control" id="calorieBurn">
                                            </div>
                                            ...
                                            <c:if test="${out.workoutId!= null}">
                                                ...
                                                <a href="<%= request.getContextPath()%>/workoutpage" class="btn btn-default pull-right" style="background-color: #F75D59; color: #ffffff">New</a>
                                            </c:if>
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered table-striped table-responsive">
                                ...
                                <tbody>
                                    <c:forEach var="row" items="${workouts}">
                                        <tr>
                                            <td>${row.workoutId}</td>
                                            <td>${row.workoutName}</td>
                                            <td>${row.calorieBurn}</td>

                                            <td><a href="<%=request.getContextPath()%>/editWorkout/${row.workoutId}">EDIT</a></td>
                                            <td>
                                                <a onclick="return confirm('Are you want to delete this item?')"
                                                   href="<%=request.getContextPath()%>/deleteWorkout/${row.workoutId}">DELETE</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
