                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body ">
                                    <c:if test="${tm.trailMemberId== null}">
                                        <form action="<%=request.getContextPath()%>/saveTrailMember" method="post" >
                                        </c:if>
                                        <c:if test="${tm.trailMemberId!= null}">
                                            <form action="<%=request.getContextPath()%>/updateTrailMember" method="post">
                                            </c:if>  

                                            <div class="form-group">
                                                <label for="trailMemberId">Trail Member Id</label>
                                                <input value="${tm.trailMemberId}" readonly="true" name="trailMemberId" type="text" class="form-control" id="trailMemberId">
                                            </div>
                                            <div class="form-group">
                                                <label for="trailMemberName">Trail Member Name:</label>
                                                <input value="${tm.trailMemberName}" name="trailMemberName" type="text" class="form-control" id="trailMemberName">
                                            </div>
                                            <div class="form-group">
                                                <label for="phone">Phone:</label>
                                                <input value="${tm.phone}" name="phone" type="text" class="form-control" id="phone">
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email:</label>
                                                <input value="${tm.email}" name="email" type="text" class="form-control" id="email">
                                            </div>
                                            ...
                                            <c:if test="${tm.trailMemberId!= null}">
                                                ...
                                                <a href="<%= request.getContextPath()%>/trailmemberpage" class="btn btn-default pull-right" style="background-color: #F75D59; color: #ffffff">New</a>
                                            </c:if>
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered table-striped table-responsive">
                                <thead>
                                    <tr>
                                        <th>Trail Member Id</th>
                                        <th>Trail Member Name</th>
                                        <th>Phone</th>
                                        <th>Email</th>
                                ...
                                <tbody>
                                    <c:forEach var="row" items="${tms}">
                                        <tr>
                                            <td>${row.trailMemberId}</td>
                                            <td>${row.trailMemberName}</td>
                                            <td>${row.phone}</td>
                                            <td>${row.email}</td>

                                            <td><a href="<%=request.getContextPath()%>/editTrailMember/${row.trailMemberId}">EDIT</a></td>
                                            <td>
                                                <a onclick="return confirm('Are you want to delete this item?')"
                                                   href="<%=request.getContextPath()%>/deleteTrailMember/${row.trailMemberId}">DELETE</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
