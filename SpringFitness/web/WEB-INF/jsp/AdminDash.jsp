                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <c:if test="${admin.adminId == null}">
                                    <form action="<%= request.getContextPath()%>/saveAdmin" method="post">
                                    </c:if>
                                    <c:if test="${admin.adminId != null}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="${admin.adminId}" readonly="true"  name="adminId" type="text" class="form-control"
                                                   id="adminId"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="${admin.password}" name="password" type="text" class="form-control"
                                                   id="password"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="role">Role:</label>
                                            <input value="${admin.role}" name="role" type="text" class="form-control"
                                                   id="role"/>
                                        </div>
                                        ...
                                        <c:if test="${admin.adminId != null}">
                                            ...
                                            <a href="<%=request.getContextPath()%>/AdminDash" class="btn btn-success pull-right" style="background-color: #F75D59; color: #ffffff">New</a>
                                        </c:if>
                                                ...
                                                <tbody>
                                                    <c:forEach var="row" items="${admins}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<%=request.getContextPath()%>/editAdmin/${row.adminId}">
                                                                    EDIT
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <a onclick="return confirm('Are you want to delete this item?')"
                                                                   href="<%=request.getContextPath()%>/deleteAdmin/${row.adminId}">
                                                                    DELETE
                                                                </a>
                                                            </td>
