                                            ...
                                            <c:if test="${employee.employeeId == null}">
                                                ...
                                                <c:if test="${employee.employeeId  != null}">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="cid">EmployeeId:</label>
                                                        <input value="${employee.employeeId}" readonly="true"  name="employeeId" type="text" class="form-control"
                                                               id="cid"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="EmployeeName">EmployeeName:</label>
                                                        <input value="${employee.employeeName}" name="employeeName" type="text" class="form-control"
                                                               id="EmployeeName"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="photo">Photo:</label>
                                                        <input value="${employee.photo}" name="photo" type="text" class="form-control"
                                                               id="photo"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="password">Password:</label>
                                                        <input value="${employee.password}" name="password" type="text" class="form-control"
                                                               id="password"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="role">Role:</label>
                                                        <input value="${employee.role}" name="role" type="text" class="form-control"
                                                               id="role"/>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="command">Gender:</label>
                                                            <INPUT TYPE="radio" name="gender" value="male">Male<INPUT TYPE="radio" NAME="gender" VALUE="female">Female
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="phone">phone:</label>
                                                            <input value="${employee.phone}" name="phone" type="phone" class="form-control"
                                                                   id="phone"/>

                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email">email:</label>
                                                            <input value="${employee.email}" name="email" type="text" class="form-control"
                                                                   id="email"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="address">address:</label>
                                                            <input value="${employee.address}" name="address" type="text" class="form-control"
                                                                   id="address"/>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <c:if test="${employee.employeeId != null}">
                                                            ...
                                                            <a href="<%=request.getContextPath()%>/EmployeeDash" class="btn btn-success pull-right" style="background-color: #F75D59; color: #ffffff">New</a>
                                                        </c:if>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="row" items="${employees}">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="<%=request.getContextPath()%>/editEmployee/${row.employeeId}">
                                                                                    EDIT
                                                                                </a>
                                                                            </td>
                                                                            <td>
                                                                                <a onclick="return confirm('Are you want to delete this item?')"
                                                                                   href="<%=request.getContextPath()%>/deleteEmployee/${row.employeeId}">
                                                                                    DELETE
                                                                                </a>
                                                                            </td>
